...
\begin{itemize}
\item the documentation is not allways up to date and sometimes incomplete
...
The installation was easy; apt-get did almost everything. Furthermore,
the configuration that was required to enabled unicast was not that
difficult to do (the documentation is in good shape, and this helps a lot).
