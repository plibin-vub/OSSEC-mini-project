...
had to consult several separate documents. The main problem seems to
...
server of the DRBD organisation. -> not sure what to think about this
...
able to configure what is important, redundancy, speed to read/write 
possibility to make snapshots
Although this software does a lot of things (nicely separate libraries
...
an island in the Portuguese Azorean archipelago (movies/wikipedia\_clone\_add\_faial.mov).
