...
Find the code for the inform-controller.sh script in src/vm_controller/inform-controller.sh.
...
haproxy server (IP address: 192.168.15.10); as demonstrated in \cref{fig:haproxy_working_browser}.
...
'ceph-node-3' will be object storage daemons \cref{subsec:ceph_architecture}.
...
the rados tool \cref{subsec:ceph_architecture}. This tool allows us to
...
so-called placement group \cref{subsec:ceph_architecture}:
\begin{lstlisting}[language=bash]
...
2014.
The total number of articles seems to increase linearly \cref{wikipedia_nr_articles_over_time}.
\begin{figure}[h!]
...
infrequent also has stabilised \cref{wikipedia_active_editors}. Between 2005 and 2007 there was a
steep growth \cref{wikipedia_active_editors}, but this growth was not
...
a steady growth \cref{wikipedia_page_views}. The growth in absolute
...
significant amount of articles since 2005 \cref{wikipedia_nr_articles_over_time}, we can assume that there
...
existing HAProxy cluster for this \cref{ha_proxy_experiment}
\end{itemize}
