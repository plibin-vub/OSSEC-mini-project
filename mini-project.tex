...
balancing algorithms, most notably:
\begin{itemize}
...
rely on session context (tarreau:2006). Since this session context is usually stored
...
cookie value presented by the user to pass the request to the correct server.

\chapter{Creating a `Wikpedia clone' cluster}
interesting hints to improve performance: Tarreau:2006 article: p 17-18
